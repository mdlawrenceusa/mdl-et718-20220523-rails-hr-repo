...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { email: @name.email, image_url: @name.image_url, location: @name.location, phone: @name.phone, role: @name.role } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { email: @name.email, image_url: @name.image_url, location: @name.location, phone: @name.phone, role: @name.role } }
